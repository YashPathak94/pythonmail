...
# List of available namespace suffixes
namespace_suffixes = ['dev', 'devB', 'devC', 'intg', 'accp', 'proda', 'prodb']
...
def generate_html_report(clusters_info, current_env, selected_suffix):
    ...
    total_pods_suffix = sum(count_pods_by_suffix(cluster['namespace_counts'], selected_suffix) for cluster in clusters_info)
